...
> **Status (v15.6.0):** This document is preserved for historical reference. The parallel computing architecture described here has since been extracted to [MathTS](https://github.com/danielsimonjr/MathTS). This repo is now a pure JavaScript library.
