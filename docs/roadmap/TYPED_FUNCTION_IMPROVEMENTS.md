...
> **Status (v15.6.0):** The issues described in this document have been resolved. The test suite now passes **9,263 tests with 0 failures** (as of 2026-04-10). This document is preserved for historical reference. The TypeScript/WASM refactoring effort described here has since been extracted to [MathTS](https://github.com/danielsimonjr/MathTS); this repo is now a pure JavaScript library.
