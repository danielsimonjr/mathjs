...
exports.createParseNumberWithConfig = void 0;
var _factory = require("./factory.js");
const name = 'parseNumberWithConfig';
const dependencies = ['config', '?bignumber'];
const createParseNumberWithConfig = exports.createParseNumberWithConfig = /* #__PURE__ */(0, _factory.factory)(name, dependencies, _ref => {
  let {
    config,
    bignumber
  } = _ref;
