...
export const createRound = /* #__PURE__ */ factory(name, dependencies, ({ typed, config, matrix, equalScalar, zeros, BigNumber, DenseMatrix }: { typed: any, config: any, matrix: any, equalScalar: any, zeros: any, BigNumber: any, DenseMatrix: any }) => {
