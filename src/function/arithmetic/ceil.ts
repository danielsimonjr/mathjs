...
export const createCeil = /* #__PURE__ */ factory(name, dependencies, ({ typed, config, round, matrix, equalScalar, zeros, DenseMatrix }: { typed: any, config: any, round: any, matrix: any, equalScalar: any, zeros: any, DenseMatrix: any }) => {
