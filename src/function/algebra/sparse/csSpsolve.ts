...
export const createCsSpsolve = /* #__PURE__ */ factory(name, dependencies as unknown as string[], ({ divideScalar, multiply, subtract }: { divideScalar: any, multiply: any, subtract: any }) => {
  /**
