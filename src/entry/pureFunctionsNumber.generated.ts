...
export const e: any = /* #__PURE__ */ createE({ config })
export const _false: any = /* #__PURE__ */ createFalse({})
export const index: any = /* #__PURE__ */ createIndex({})
export const _Infinity: any = /* #__PURE__ */ createInfinity({ config })
export const LN10: any = /* #__PURE__ */ createLN10({ config })
export const LOG10E: any = /* #__PURE__ */ createLOG10E({ config })
...
export const SQRT1_2: any = /* #__PURE__ */ createSQRT1_2({ config })
export const subset: any = /* #__PURE__ */ createSubset({})
export const tau: any = /* #__PURE__ */ createTau({ config })
export const typed: any = /* #__PURE__ */ createTyped({})
export const unaryPlus: any = /* #__PURE__ */ createUnaryPlus({ typed })
export const version: any = /* #__PURE__ */ createVersion({})
export const xor: any = /* #__PURE__ */ createXor({ typed })
export const abs: any = /* #__PURE__ */ createAbs({ typed })
export const acos: any = /* #__PURE__ */ createAcos({ typed })
export const acot: any = /* #__PURE__ */ createAcot({ typed })
export const acsc: any = /* #__PURE__ */ createAcsc({ typed })
export const add: any = /* #__PURE__ */ createAdd({ typed })
export const and: any = /* #__PURE__ */ createAnd({ typed })
export const asec: any = /* #__PURE__ */ createAsec({ typed })
export const asin: any = /* #__PURE__ */ createAsin({ typed })
export const atan: any = /* #__PURE__ */ createAtan({ typed })
export const atanh: any = /* #__PURE__ */ createAtanh({ typed })
export const bigint: any = /* #__PURE__ */ createBigint({ typed })
export const bitNot: any = /* #__PURE__ */ createBitNot({ typed })
export const bitXor: any = /* #__PURE__ */ createBitXor({ typed })
export const boolean: any = /* #__PURE__ */ createBoolean({ typed })
export const cbrt: any = /* #__PURE__ */ createCbrt({ typed })
export const combinations: any = /* #__PURE__ */ createCombinations({ typed })
export const compare: any = /* #__PURE__ */ createCompare({ config, typed })
export const compareText: any = /* #__PURE__ */ createCompareText({ typed })
export const cos: any = /* #__PURE__ */ createCos({ typed })
export const cot: any = /* #__PURE__ */ createCot({ typed })
...
export const gamma: any = /* #__PURE__ */ createGamma({ typed })
export const isBounded: any = /* #__PURE__ */ createIsBounded({ typed })
export const isInteger: any = /* #__PURE__ */ createIsInteger({ typed })
export const isNegative: any = /* #__PURE__ */ createIsNegative({ typed })
export const isPositive: any = /* #__PURE__ */ createIsPositive({ typed })
export const isZero: any = /* #__PURE__ */ createIsZero({ typed })
export const LOG2E: any = /* #__PURE__ */ createLOG2E({ config })
export const largerEq: any = /* #__PURE__ */ createLargerEq({ config, typed })
export const leftShift: any = /* #__PURE__ */ createLeftShift({ typed })
export const log: any = /* #__PURE__ */ createLog({ typed })
export const log1p: any = /* #__PURE__ */ createLog1p({ typed })
export const map: any = /* #__PURE__ */ createMap({ typed })
export const mean: any = /* #__PURE__ */ createMean({ add, divide, typed })
export const mod: any = /* #__PURE__ */ createMod({ typed })
export const multiply: any = /* #__PURE__ */ createMultiply({ typed })
export const not: any = /* #__PURE__ */ createNot({ typed })
export const number: any = /* #__PURE__ */ createNumber({ typed })
export const or: any = /* #__PURE__ */ createOr({ typed })
export const pi: any = /* #__PURE__ */ createPi({ config })
export const pow: any = /* #__PURE__ */ createPow({ typed })
export const random: any = /* #__PURE__ */ createRandom({ config, typed })
export const rightLogShift: any = /* #__PURE__ */ createRightLogShift({ typed })
export const SQRT2: any = /* #__PURE__ */ createSQRT2({ config })
export const sech: any = /* #__PURE__ */ createSech({ typed })
export const sin: any = /* #__PURE__ */ createSin({ typed })
export const size: any = /* #__PURE__ */ createSize({ typed })
export const smallerEq: any = /* #__PURE__ */ createSmallerEq({ config, typed })
...
export const prod: any = /* #__PURE__ */ createProd({ config, multiplyScalar, numeric, typed })
...
export const sum: any = /* #__PURE__ */ createSum({ add, config, numeric, typed })
