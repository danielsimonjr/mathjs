...
describe('approx', function (): void {
  it('should test equality of positive values', function (): void {
    ...
    assert.throws(
      () => approxEqual(2, 2.0000000001, 1e-11),
      assert.AssertionError
    )
    assert.throws(
      () => approxEqual(2, 1.9999999999, 1e-11),
      assert.AssertionError
    )
  })
  ...
  it('should test equality of very large values', function (): void {
    ...
    assert.throws(
      () => approxEqual(2e100, 2.0000000001e100, 1e-11),
      assert.AssertionError
    )
    assert.throws(
      () => approxEqual(2e100, 1.9999999999e100, 1e-11),
      assert.AssertionError
    )
  })
  ...
  it('should test equality of very small values', function (): void {
    ...
    assert.throws(
      () => approxEqual(2e-100, 2.0000000001e-100, 1e-11),
      assert.AssertionError
    )
    assert.throws(
      () => approxEqual(2e-100, 1.9999999999e-100, 1e-11),
      assert.AssertionError
    )
  })
  ...
  it('should test equality when one of the values is zero', function (): void {
    ...
    assert.throws(
      () => approxEqual(0, 0.00000000009, 1e-11),
      assert.AssertionError
    )
  })
