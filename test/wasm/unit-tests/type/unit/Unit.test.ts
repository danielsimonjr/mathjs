...
describe('Unit', function (): void {
  ...
  describe('deleteUnit', function (): void {
    it('should delete a unit', function (): void {
      ...
      assert.throws(function (): void { math2.evaluate('5 b').toString() }, 'foo')
      assert.throws(function (): void { math2.evaluate('5 bytes').toString() }, 'foo')
      assert.throws(function (): void { math2.evaluate('5 byte').toString() }, 'foo')
