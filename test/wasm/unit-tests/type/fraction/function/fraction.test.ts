...
describe('fraction', function (): void {
  ...
  it('should fail to create a fraction in case of non-integer quotient', function (): void {
    assert.throws(function (): void { math.fraction(4, 5.1) }, /Parameters must be integer/)
    assert.throws(function (): void { math.fraction(62.8, 10) }, /Parameters must be integer/)
    assert.throws(function (): void { math.fraction(Infinity, 3) },
