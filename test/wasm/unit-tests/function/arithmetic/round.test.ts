...
describe('round', function (): void {
  ...
  it('should round fractions', function (): void {
    ...
    assert.deepStrictEqual(
      round(fraction(2, 3), bignumber(2)),
      fraction(67, 100)
    )
  })
  ...
  it('should round units', function (): void {
    ...
    // bignumber values
    assert.deepStrictEqual(
      round(unit('3.12345 cm'), bignumber(2), unit('cm')),
      unit('3.12 cm')
    )
    assert.deepStrictEqual(
      round(unit(bignumber('2'), 'inch'), unit('cm')),
      unit(bignumber('5'), 'cm')
    )
    assert.deepStrictEqual(
      round(unit(bignumber('2'), 'inch'), bignumber(1), unit('cm')),
      unit(bignumber('5.1'), 'cm')
    )

    // first argument is a collection
    assert.deepStrictEqual(
      round([unit('2 inch'), unit('3 inch')], unit('cm')),
      [unit('5 cm'), unit('8 cm')]
    )
    assert.deepStrictEqual(
      round(matrix([unit('2 inch'), unit('3 inch')]), unit('cm')),
      matrix([unit('5 cm'), unit('8 cm')])
    )
  })
  ...
  describe('DenseMatrix', function (): void {
    ...
    it('should round dense matrix and scalar', function (): void {
      ...
      assert.deepStrictEqual(
        round(complex(2.7182, 6.2831), matrix([2, 3])),
  ...
  describe('SparseMatrix', function (): void {
    ...
    it('should round sparse matrix and scalar', function (): void {
      ...
      assert.deepStrictEqual(
        round(bignumber(6.28318), sparse([0, 4])),
