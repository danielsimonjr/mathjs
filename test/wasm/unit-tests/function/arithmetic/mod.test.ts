/**
 * Test for mod - AssemblyScript-friendly TypeScript
 */
...
describe('mod', function (): void {
  it('should calculate the modulus of booleans correctly', function (): void {
  ...
  it('should calculate the modulus of two bigints', function (): void {
  ...
  it('should handle precise approximation of float approximation', function (): void {
  ...
  it('should throw an error if used with wrong type of arguments', function (): void {
    assert.throws(function (): void {
      mod(1, new Date())
  ...
  it('should calculate the modulus of bignumbers', function (): void {
  ...
  it('should calculate the modulus of bignumbers for negative dividend', function (): void {
  ...
  it('should calculate the modulus of bignumbers for a negative divisor', function (): void {
    assert.deepStrictEqual(mod(bignumber(10), bignumber(-4)), bignumber(-2))
  })

  it('should calculate the modulus of mixed numbers and bignumbers', function (): void {
  ...
  it('should calculate the modulus of mixed booleans and bignumbers', function (): void {
  ...
  it('should throw an error if used on complex numbers', function (): void {
    assert.throws(function (): void {
  ...
  it('should convert string to number', function (): void {
  ...
  it('should calculate modulus of two fractions', function (): void {
  ...
  it('should calculate the modulus of fractions for negative dividend', function (): void {
    assert.strictEqual(
  ...
  it('should calculate the modulus of fractions for a negative divisor', function (): void {
    assert.strictEqual(
      mod(math.fraction(10), math.fraction(-4)).toString(),
      '-2'
    )
  ...
  it('should calculate modulus of mixed fractions and numbers', function (): void {
  ...
  describe('Array', function (): void {
    it('should perform element-wise modulus on array and scalar', function (): void {
      approxDeepEqual(
        mod(
          [
            [-4, -3, 0, -1],
    ...
    it('should perform element-wise modulus on broadcastable arrays', function (): void {
    ...
    it('should perform element-wise modulus on array and array', function (): void {
      approxDeepEqual(
        mod(
          [
            [-40, -31],
    ...
    it('should perform element-wise modulus on array and dense matrix', function (): void {
      approxDeepEqual(
        mod(
          [
            [-40, -31],
    ...
    it('should perform element-wise modulus on array and sparse matrix', function (): void {
      approxDeepEqual(
        mod(
          [
            [-40, -31],
  ...
  describe('DenseMatrix', function (): void {
    it('should perform element-wise modulus on dense matrix and scalar', function (): void {
      approxDeepEqual(
        mod(
          matrix([
            [-4, -3, 0, -1],
    ...
    it('should perform element-wise modulus on dense matrix and array', function (): void {
      approxDeepEqual(
        mod(
          matrix([
            [-40, -31],
    ...
    it('should perform element-wise modulus on dense matrix and dense matrix', function (): void {
      approxDeepEqual(
        mod(
          matrix([
            [-40, -31],
    ...
    it('should perform element-wise modulus on dense matrix and sparse matrix', function (): void {
      approxDeepEqual(
        mod(
          matrix([
            [-40, -31],
  ...
  describe('SparseMatrix', function (): void {
    it('should perform element-wise modulus on sparse matrix and scalar', function (): void {
      approxDeepEqual(
        mod(
          sparse([
            [-4, -3, 0, -1],
    ...
    it('should perform element-wise modulus on sparse matrix and array', function (): void {
      approxDeepEqual(
        mod(
          sparse([
            [-40, -31],
    ...
    it('should perform element-wise modulus on sparse matrix and dense matrix', function (): void {
      approxDeepEqual(
        mod(
          sparse([
            [-40, -31],
    ...
    it('should perform element-wise modulus on sparse matrix and sparse matrix', function (): void {
      approxDeepEqual(
        mod(
          sparse([
            [-40, -31],
  ...
  it('should LaTeX mod', function (): void {
