...
describe('sylvester', function (): void {
    ...
    assert.ok(
      math.norm(
        math.subtract(
          ...
          [
            [
              -0.19393862606643053, -0.17101629636521865, 2.709348263225366,
              -0.0963000767188319, 0.5244718194343121
            ],
            [
              0.38421326955977486, -0.21159588555260944, -6.544262021555474,
              -0.15113424769761136, -2.312533293658291
            ],
            [
              -2.2708235174374747, 4.498279916441834, 1.4553799673144823,
              -0.9300926971755248, 2.5508111398452353
            ],
            [
              -1.0935231387905004, 4.113817086842746, 5.747671819196675,
              -0.9408309030864932, 2.967655969930743
            ]
          ]
        ),
        'fro'
  ...
  it('should work with config legacySubset during deprecation', function (): void {
    ...
    assert.ok(
      math2.norm(
        math2.subtract(
          math2.sylvester(sylvesterA, sylvesterB, sylvesterC),
          sylvesterSol
        ),
        'fro'
      ) < 1e-3
