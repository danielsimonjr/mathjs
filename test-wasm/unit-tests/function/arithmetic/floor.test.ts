...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor(bignumber(2.135), bignumber(2)),
      bignumber(2.13)
    )
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor(complex(1.315, 1.878), bignumber(2)),
      complex(1.31, 1.87)
    )
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor(fraction(44, 7), bignumber(2)),
      fraction(628, 100)
    )
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor(unit('3.12345 cm'), 3, unit('cm')),
      unit('3.123 cm')
    )
    ...
    // bignumber values
    assert.deepStrictEqual(
      floor(unit('3.12345 cm'), bignumber(2), unit('cm')),
      unit('3.12 cm')
    )
    assert.deepStrictEqual(
      floor(unit(bignumber('2'), 'inch'), unit('cm')),
      unit(bignumber('5'), 'cm')
    )
    assert.deepStrictEqual(
      floor(unit(bignumber('2'), 'inch'), bignumber(1), unit('cm')),
      unit(bignumber('5.0'), 'cm')
    )

    // first argument is a collection
    assert.deepStrictEqual(
      floor([unit('2 inch'), unit('3 inch')], unit('cm')),
      [unit('5 cm'), unit('7 cm')]
    )
    assert.deepStrictEqual(
      floor(matrix([unit('2 inch'), unit('3 inch')]), unit('cm')),
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor([1.282, 3.415, -5.121, -10.128], bignumber(2)),
      [bignumber(1.28), bignumber(3.41), bignumber(-5.13), bignumber(-10.13)]
    )
    assert.deepStrictEqual(
    ...
    assert.deepStrictEqual(
      floor(matrix([1.282, 3.415, -5.121, -10.128]), bignumber(2)),
      matrix([
        bignumber(1.28),
        bignumber(3.41),
        bignumber(-5.13),
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      ...
      bignumber([3.12, 3.123])
    )
    assert.deepStrictEqual(floor(complex(3.12385, -1.6789), [2, 3]), [
      complex(3.12, -1.68),
      complex(3.123, -1.679)
    ])
    assert.deepStrictEqual(floor(fraction(44, 7), [2, 3]), [
      fraction(628, 100),
      fraction(6285, 1000)
    ])
  })
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    assert.deepStrictEqual(
      floor(bignumber(3.12385), sparse([2, 3])),
      bignumber(matrix([[3.12], [3.123]]))
    )
    assert.deepStrictEqual(
      floor(complex(3.12385, -1.6789), matrix([2, 3])),
      matrix([complex(3.12, -1.68), complex(3.123, -1.679)])
    )
    assert.deepStrictEqual(
      floor(fraction(44, 7), sparse([2, 3])),
      matrix([[fraction(628, 100)], [fraction(6285, 1000)]])
    )
  })
