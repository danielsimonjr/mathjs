...
describe('zpk2tf', function (): void {
  it('should return the transfer function of a zero-pole-gain model', function (): void {
    approxDeepEqual(
      zpk2tf(
        [math.complex(1, 5)],
        [math.complex(-2, 0), math.complex(-3, 0)],
        1
      ),
      [
    ...
    approxDeepEqual(
      ...
      [
        [math.complex(2, 0), math.complex(-2, -10)],
        [math.complex(1, 0), math.complex(5, 0), math.complex(6, 0)]
      ]
    )
  })
  ...
  it('should return the transfer function of a zero-pole-gain model with number parameters', function (): void {
    ...
    approxDeepEqual(zpk2tf([1, 5], [-2, -3], 1), [
      [math.complex(1, 0), math.complex(-6, 0), math.complex(5, 0)],
      [math.complex(1, 0), math.complex(5, 0), math.complex(6, 0)]
    ])
  ...
  it('should return the transfer function of a zero-pole-gain model with matrix parameters', function (): void {
    approxDeepEqual(
      zpk2tf(
        ...
        math.matrix([math.complex(-2, 0), math.complex(-3, 0)]),
        1
      ),
      [
        [math.complex(1, 0), math.complex(-1, -5)],
