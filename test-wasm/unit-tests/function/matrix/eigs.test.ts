...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    testEigenvectors(genericArray, (vector) =>
      assert(Array.isArray(vector) && vector[0] instanceof Complex)
    )
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    testEigenvectors(ans, (v, j) =>
      approxDeepEqual(multiply(E[j], v), multiply(H, v))
    )
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    ...
    const fromWeb = eigs([
      [-2, 1],
      [-1, 0]
    ]) // https://ocw.mit.edu/courses/18-03sc-differential-equations-fall-2011/051316d5fa93f560934d3e410f8d153d_MIT18_03SCF11_s33_8text.pdf
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    const fromWeb = eigs([
      ...
      [0, 2, 0],
      [-1, 4, 1]
    ]) // https://math.libretexts.org/Bookshelves/Differential_Equations/Differential_Equations_for_Engineers_(Lebl)/3%3A_Systems_of_ODEs/3.7%3A_Multiple_Eigenvalues
