...
=======
/**
 * Test for equal - AssemblyScript-friendly TypeScript
 */
...
<<<<<<< HEAD
  it('should compare mixed numbers and bigint', function () {
    ...
    assert.throws(function () {
      equal(123123123123123123123n, 1)
    }, /Cannot implicitly convert bigint to number: value exceeds the max safe integer value/)
    assert.throws(function () {
=======
  it('should compare mixed numbers and bigint', function (): void {
    assert.deepStrictEqual(equal(2n, 3), false)
    assert.deepStrictEqual(equal(2, 2n), true)
    ...
    assert.throws(function (): void {
>>>>>>> claude/review-sprints-quality-checks-Rlfec
      equal(1, 123123123123123123123n)
    }, /Cannot implicitly convert bigint to number: value exceeds the max safe integer value/)
  })
...
=======
  it('should compare strings by their numeric value', function (): void {
>>>>>>> claude/review-sprints-quality-checks-Rlfec
    assert.strictEqual(equal('2', 2), true)
...
<<<<<<< HEAD
  it('should throw an error when comparing a unit with a big number', function () {
    assert.throws(function () {
=======
  it('should throw an error when comparing a unit with a big number', function (): void {
    assert.throws(function (): void {
>>>>>>> claude/review-sprints-quality-checks-Rlfec
...
<<<<<<< HEAD
  it('should throw an error when comparing a unit with a number', function () {
    assert.throws(function () {
=======
  it('should throw an error when comparing a unit with a number', function (): void {
    assert.throws(function (): void {
>>>>>>> claude/review-sprints-quality-checks-Rlfec
      equal(unit('100cm'), 22)
    })
...
>>>>>>> claude/review-sprints-quality-checks-Rlfec
      assert.deepStrictEqual(equal([[1, 2, 0]], [[1], [0]]), [
        [true, false, false],
        [false, false, true]
      ])
    })
...
=======
  it('should LaTeX equal', function (): void {
>>>>>>> claude/review-sprints-quality-checks-Rlfec
