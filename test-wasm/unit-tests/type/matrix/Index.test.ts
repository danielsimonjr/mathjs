...
describe('Index', function () {
  ...
  it('should create an Index from bigints', function () {
    ...
    assert.deepStrictEqual(new Index(new Range(0n, 10n, 2))._dimensions, [
      new Range(0, 10, 2)
    ])
    assert.deepStrictEqual(
      new Index(new Range(0n, 10n), new Range(4, 6))._dimensions,
      [new Range(0, 10, 1), new Range(4, 6, 1)]
    )
  })
  ...
  it('should expand an index into an array', function () {
    ...
    assert.deepStrictEqual(
      new Index(2, new Range(0, 8, 2), new Range(3, -1, -1), [1, 2]).toArray(),
