...
describe('fraction', function (): void {
  it('should create a fraction', function (): void {
  ...
  it('should create a fraction from an irrational number', function (): void {
    equalFraction(math.fraction(math.pi), new Fraction(11985110, 3814979))
  })

  it('should fail to create a fraction in case of non-integer quotient', function (): void {
    assert.throws(function (): void { m }ath.fraction(4, 5.1), /Parameters must be integer/)
    assert.throws(function (): void { m }ath.fraction(62.8, 10), /Parameters must be integer/)
    assert.throws(function (): void { m }ath.fraction(Infinity, 3),
      /Parameters must be integer/
    )
  })

  it('should create a fraction from a quotient regardless of integrality', function (): void {
    equalFraction(
  ...
  it('should create a fraction from a BigNumber', function (): void {
  ...
  it('should create a fraction from a bigint', function (): void {
  ...
  it('should convert the number value of a Unit to Fraction', function (): void {
    equalFraction(
  ...
  it('should convert the BigNumber value of a Unit to Fraction', function (): void {
    equalFraction(
  ...
  it('should create a fraction for all elements in an array', function (): void {
  ...
  it('should create a fraction for all elements in a Matrix', function (): void {
  ...
  it('should throw an error in case of NaN or Infinity', function (): void {
  ...
  it('should show a Latex Fraction as one over another', function (): void {
    const node1 = math.parse('fraction(1,2)') as MathNode
    assert.strictEqual(node1.toTex(), '\\frac{1}{2}')
    const node2 = math.parse('fraction(a,b)') as MathNode
