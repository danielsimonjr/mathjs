...
describe('Unit', function (): void {
  describe('constructor', function (): void {
    it('should create unit correctly', function (): void {
    ...
    it('should create a unit with Fraction value', function (): void {
    ...
    it('should create a unit with BigNumber value', function (): void {
    ...
    it('should create a unit with Complex value', function (): void {
    ...
    it('should create a unitless Unit if second parameter is undefined', function (): void {
      const a = new Unit(6)
      assert(a.dimensions.every((d) => d === 0))
    })

    it('should ignore properties on Object.prototype', function (): void {
    ...
    it('should throw an error if called without new keyword', function (): void {
      assert.throws(function (): void {
        Unit(2, 'inch')
      })
    })

    it('should throw an error if called with wrong type of arguments', function (): void {
      assert.throws(function (): void {
    ...
    it('should skip automatic simplification if created directly in the constructor', function (): void {
  ...
  describe('isValuelessUnit', function (): void {
    it('should return true if the string is a plain unit', function (): void {
    ...
    it('should return false if the unit is not a plain unit', function (): void {
  ...
  describe('type', function (): void {
    it('should have a property isUnit', function (): void {
  ...
  describe('hasBase', function (): void {
    it('should test whether a unit has a certain base unit', function (): void {
      assert.strictEqual(
  ...
  describe('equalBase', function (): void {
    it('should test whether two units have the same base unit', function (): void {
  ...
  describe('equals', function (): void {
    it('should test whether two units are equal', function (): void {
    ...
    it('should test whether two units with Fractions are equal', function (): void {
      assert.strictEqual(
    ...
    it('should test whether two units with a Fraction and a number are equal', function (): void {
      assert.strictEqual(
    ...
    it('should test whether two Complex units are equal', function (): void {
      assert.strictEqual(
    ...
    it('should test whether a Complex unit and a unit with a number are equal', function (): void {
      assert.strictEqual(
  ...
  describe('clone', function (): void {
    ...
    it('should clone a with a Fraction', function (): void {
    ...
    it('should clone a Complex unit', function (): void {
  ...
  describe('toNumber', function (): void {
    ...
    it('should convert a unit with fixed prefix to a number', function (): void {
    ...
    it('should convert a unit with fraction to a number', function (): void {
      const u = new Unit(math.fraction(5), 'cm')
      assert.strictEqual(u.toNumber('mm'), 50)
    })

    it('should convert a unit with value only to a number', function (): void {
      const u = Unit.parse('5', { allowNoUnits: true })
      assert.strictEqual(u.toNumber(), 5)
    })
  })

  describe('toNumeric', function (): void {
    it('should convert a unit to a numeric value', function (): void {
  ...
  describe('to', function (): void {
    it('should convert a unit to a fixed unitName', function (): void {
      const u1 = new Unit(5000, 'cm')
    ...
    it('should avoid round-off in offset conversions', function (): void {
      assert.strictEqual(
    ...
    it('should avoid bignumber round-off in offset conversions', function (): void {
      assert.deepEqual(
    ...
    it('should convert a unit with a fraction', function (): void {
    ...
    it('should convert a Complex unit', function (): void {
    ...
    it('should convert a unit to a fixed unit', function (): void {
      const u1 = new Unit(5000, 'cm')
      assert.strictEqual(u1.value, 50)
      assert.strictEqual(u1.units[0].unit.name, 'm')
      assert.strictEqual(u1.units[0].prefix.name, 'c')
    ...
    it('should convert a valueless unit', function (): void {
    ...
    it('should convert a unitless quantity', function (): void {
      const u = Unit.parse('5', { allowNoUnits: true })
      assert.strictEqual(u.toNumeric(), 5)
      assert.strictEqual(u.toNumeric('mm/m'), 5000)
    })

    it('should convert a binary prefixes (1)', function (): void {
    ...
    it('should convert a binary prefixes (2)', function (): void {
    ...
    it('should skip automatic simplification if unit is result of to or toSI', function (): void {
    ...
    it('should throw an error when converting to an incompatible unit', function (): void {
      const u1 = new Unit(5000, 'cm')
      assert.throws(function (): void {
        u1.to('kg')
      }, /Units do not match/)
    ...
    it('should throw an error when converting to a unit having a value', function (): void {
      const u1 = new Unit(5000, 'cm')
      assert.throws(function (): void {
        u1.to(new Unit(4, 'm'))
    ...
    it('should throw an error when converting to an unsupported type of argument', function (): void {
      const u1 = new Unit(5000, 'cm')
      assert.throws(function (): void {
        u1.to(new Date())
  ...
  describe('toString', function (): void {
    it('should convert to string properly', function (): void {
    ...
    it('should render with the best prefix', function (): void {
    ...
    it('should keep the original prefix when in range', function (): void {
    ...
    it('should render best prefix for a single unit raised to integral power', function (): void {
    ...
    it('should not render best prefix if "fixPrefix" is set', function (): void {
    ...
    it('should convert a unit with Fraction to string properly', function (): void {
      assert.strictEqual(
    ...
    it('should convert a Complex unit to string properly', function (): void {
      assert.strictEqual(
  ...
  describe('simplify', function (): void {
    it('should not simplify units created with new Unit()', function (): void {
    ...
    it('should only simplify units with values', function (): void {
    ...
    it('should simplify units when they cancel out with {predictable: true}', function (): void {
    ...
    it('should convert units to appropriate _numeric_ values when they cancel out with {predictable: false}', function (): void {
    ...
    it('should simplify units according to chosen unit system', function (): void {
    ...
    it('should correctly simplify units when unit system is "auto"', function (): void {
      Unit.setUnitSystem('auto')
      const unit1 = new Unit(5, 'lbf min / s')
      assert.strictEqual(unit1.simplify().toString(), '300 lbf')
    })

    it('should simplify user-defined units when unit system is "auto"', function (): void {
      Unit.setUnitSystem('auto')
      Unit.createUnit({ USD: '' })
  ...
  describe('json', function (): void {
    ...
    it('toJSON -> fromJSON should recover an "equal" unit', function (): void {
  ...
  describe('format', function (): void {
    it('should format units with given precision', function (): void {
    ...
    it('should format a unit without value', function (): void {
    ...
    it('should format a unit with fixed prefix and without value', function (): void {
    ...
    it('should format a unit with a bignumber', function (): void {
      assert.strictEqual(
    ...
    it('should format a unit with a fraction', function (): void {
      assert.strictEqual(new Unit(math.fraction(4 / 5), 'm').format(), '4/5 m')
    })

    it('should format a Complex unit', function (): void {
      assert.strictEqual(
    ...
    it('should format units with VA and VAR correctly', function (): void {
      assert.strictEqual(
    ...
    it('should ignore properties in Object.prototype when finding the best prefix', function (): void {
  ...
  describe('parse', function (): void {
    it('should parse units correctly', function (): void {
      let unit1
    ...
    it('should parse expressions with nested parentheses correctly', function (): void {
    ...
    it('should parse units with correct precedence', function (): void {
    ...
    it('should throw an exception when parsing an invalid unit', function (): void {
      assert.throws(function (): void {
        Unit.parse('.meter')
      }, /Unexpected "\."/)
      assert.throws(function (): void {
    ...
    it('should throw an exception when parsing an invalid type of argument', function (): void {
      assert.throws(function (): void {
        Unit.parse(123)
      }, /TypeError: Invalid argument in Unit.parse, string expected/)
    })

    it('should parse the value of the unit as Fraction or BigNumber when math.js is configured so', function (): void {
    ...
    it('should parse new units that override old units', function (): void {
    ...
    it('should support prefixes on specific units', function (): void {
  ...
  describe('prefixes', function (): void {
    it('should accept both long and short prefixes for ohm', function (): void {
    ...
    it('should accept both long and short prefixes for bar', function (): void {
  ...
  describe('metric prefixes adopted by BIPM in 2022: Q(uetta), R(onna), r(onto), and q(uecto)', function (): void {
    it('should accept long prefixes', function (): void {
      assert.strictEqual(
    ...
    it('should accept short prefixes', function (): void {
  ...
  describe('_isDerived', function (): void {
    it('should return the correct value', function (): void {
  ...
  describe('multiply, divide, and pow', function (): void {
    it('should return a Unit that will be automatically simplified', function (): void {
    ...
    it('should retain the units of their operands without simplifying', function (): void {
    ...
    it('should keep the same numeric type for the units value', function (): void {
    ...
    it('should multiply/divide units with offsets correctly', function (): void {
    ...
    it('should multiply valueless units by any supported numeric type', function (): void {
    ...
    it('should divide valueless units by any supported numeric type', function (): void {
      const valuelessF = new Unit(null, 'fahrenheit')
      assert.strictEqual(
  ...
  describe('plurals', function (): void {
    it('should support plurals', function (): void {
  ...
  describe('aliases', function (): void {
    it('should support aliases', function (): void {
  ...
  describe('UNITS', function (): void {
    it('should be of the correct value and dimension', function (): void {
    ...
    it("For each built-in unit, 'name' should match key", function (): void {
  ...
  describe('angles', function (): void {
    it('should create angles', function (): void {
    ...
    it('should have correct long/short prefixes', function (): void {
  ...
  describe('createUnitSingle', function (): void {
    it('should create a custom unit from a string definition', function (): void {
    ...
    it('should create a custom unit from a Unit definition', function (): void {
    ...
    it('should create a custom unit from a configuration object', function (): void {
    ...
    it('should return the new (value-less) unit', function (): void {
    ...
    it('should not override an existing unit', function (): void {
      assert.throws(function (): void {
    ...
    it('should throw an error for invalid parameters', function (): void {
      assert.throws(function (): void {
    ...
    it('should apply the correct prefixes', function (): void {
    ...
    it('should override prefixed built-in units', function (): void {
    ...
    it('should create aliases', function (): void {
    ...
    it('should not override base units', function (): void {
      assert.throws(function (): void {
        Unit.createUnitSingle('fooBase', '', { override: true })
      }, /Cannot create/)
    })

    it('should create and use a new base if no matching base exists', function (): void {
    ...
    it('should use baseName', function (): void {
  ...
  describe('createUnit', function (): void {
    ...
    it('should override units when requested and if able', function (): void {
      assert.throws(function (): void {
    ...
    it('should throw error when first parameter is not an object', function (): void {
      assert.throws(function (): void {
  ...
  describe('deleteUnit', function (): void {
    it('should delete a unit', function (): void {
      const math2 = math.create()
      ...
      assert.throws(function (): void { m }ath2.evaluate('5 b').toString(), 'foo')
      assert.throws(function (): void { m }ath2.evaluate('5 bytes').toString(), 'foo')
      assert.throws(function (): void { m }ath2.evaluate('5 byte').toString(), 'foo')
  ...
  describe('splitUnit', function (): void {
    ...
    it('should be resistant to round-off error', function (): void {
      assert.strictEqual(
  ...
  describe('toSI', function (): void {
    it('should return a clone of the unit', function (): void {
      const u1 = Unit.parse('3 ft')
      const u2 = u1.toSI()
      assert.strictEqual(u1 === u2, false)
    })

    it('should return the unit in SI units', function (): void {
    ...
    it('should return SI units for valueless units', function (): void {
      assert.strictEqual(Unit.parse('ft/minute').toSI().toString(), 'm / s')
    })

    it('should return SI units for custom units defined from other units', function (): void {
    ...
    it('should throw if custom unit not defined from existing units', function (): void {
  ...
  describe('isValidAlpha', function (): void {
    it('per default refuse to parse non-latin unit names', function (): void {
      assert.throws(function (): void {
        Unit.createUnit({ чекушки: '0.25 L' })
      }, /Error: Invalid unit name/)
    })

    it('should support cyrillic when Unit.isValidAlpha is overridden', function (): void {
    ...
    it('should support wide range of european alphabets when Unit.isValidAlpha is overridden', function (): void {
      const isAlphaOriginal = math.Unit.isValidAlpha
      Unit.isValidAlpha = function (c) {
